...
<div class="max-w-4xl w-full bg-white shadow-md rounded-lg overflow-hidden md:max-w-4xl">
    <div class="md:flex">
        <div class="w-full h-48 md:h-auto md:w-50 bg-cover bg-center" style="object-fit: contain;">
        ...
        <div class="w-full p-8">
            ...
            <form method="POST" action="#" class="mt-4">
                ...
                <div class="mt-4 flex items-center justify-between">
                    <button type="submit" class="w-full px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">Login</button>
                </div>
            </form>
            <div class="mt-4 flex items-center justify-between">
                <a href="#" class="text-center w-full px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
                    Register
                </a>
            </div>
        </div>
